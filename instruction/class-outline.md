...
# Intro to the F1 lasers
  ...
  - it can engrave and cut a variety of light organic materials and can mark or etch some metals
  - the visible light laser can oxidize the surface of some metals (stainless steel, titanium) to
...
# Materials
  ...
  - visible lasers are effective on paper, cardboard, acrylic, light wood, stone
...
# Safety
  ...
  - without the filter, it's a Class 4 laser, and requires protective eyewear or shielding for any who 
    could be exposed.
  - It is against studio policy to operate defeat the safety switch and operate this as a Class 4 laser
    when there are other people who could be exposed. 
...
# Setup and laser orientation
  ...
  - laser turned on
  - exhaust duct is attached depending on laser
  - XCS software launched and connected to laser
    - all device settings have safety switched ENABLED
...
and provide a similar, if somewhat different organization of the UI. 
  ...
  - left tool bar is the tools for placing objects on the canvas (you can now have more than one)
...
### for the F1 Ultra
  - press the long button on the bottom of the touch panel
  - its much harder to hit the emergency shutoff accidentally
